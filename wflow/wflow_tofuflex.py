    ...
    *Required*
    ...
    def dynamic(self):
        ...
        *Required*
        ...
        # TOTAL RUNOFF =============================================================================================
        self.Qftotal = sum([x * y for x, y in zip(self.Qf_, self.percent)]) + sum([x * y for x, y in zip(self.Qfa_, self.percent)]) + sum([x * y for x, y in zip(self.Qeia_, self.percent)]) #Qeia bypasses Sf lag-function(s) and directly go into routing.
